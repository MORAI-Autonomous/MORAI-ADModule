...
from utils.polygon_util import calculate_centroid
...
class ParkingSpace(SurfaceMarking):
    def __init__(self, points=None, idx=None):
        ...
        self.points = points
        self.center_point = calculate_centroid(points)
    ...
    def to_dict(self):
        ...
        dict_data = {
            ...
            'center_point':self.pointToList(calculate_centroid(self.points)),
