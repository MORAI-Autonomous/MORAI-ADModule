...
import save_load.subproc_load_link_ver1 as subproc_load_link_ver1
import save_load.subproc_load_link_ver2 as subproc_load_link_ver2
...
class MGeo():
    ...
    def save_intersection_state(output_path, intscn_states):
        ...
        save_info_list = []
        for state in intscn_states:
            dict_data = state.to_dict(state)
            save_info_list.append(dict_data)
